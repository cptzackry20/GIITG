...
// Initialize a variable to store the quiz update status
$quizUpdateStatus = '';

// Handle the form submission to add questions
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (!empty($_POST['question_text'])) {
        ...
        for ($i = 0; $i < count($_POST['question_text']); $i++) {
            // ... your existing code for inserting questions ...
...
<script>
    $(document).ready(function () {
        ...
        $('.edit-question').click(function () {
            ...
            var optionC = row.find('.option-c').text(); // Fixed typo here
